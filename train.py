...
def train(
    ...
    with open(os.path.join(log_dir, "data_automl.yml"), "w") as f:
        yaml.dump(data_config, f, default_flow_style=False)
    with open(os.path.join(log_dir, "model_automl.yml"), "w") as f:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model",
        default="result/model.yml",
        type=str,
        help="model config",
    )
    parser.add_argument(
        "--data", default="result/data.yml", type=str, help="data config"
    )
